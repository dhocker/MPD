...
The following sections provide some direction for compiling and installing MPD
...
* download the source as a tar ball
* clone the MPD repo from GitHub
...
Or, clone the source from GitHub:
